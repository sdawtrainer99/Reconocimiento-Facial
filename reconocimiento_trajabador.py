...
#model = cv2.face.getFacesHAAR()
#model.train(images, lables)

# Parte 2: Utilizar el modelo entrenado en funcionamiento con la camara
#face_cascade = cv2.CascadeClassifier( 'v\lbpcascades\lbpcascade_frontalface_improved.xml')
face_cascade = cv2.CascadeClassifier( 'v\haarcascades\haarcascade_frontalface_alt2.xml')
cap = cv2.VideoCapture(0)
#figueroa arias espe latacunga repositorio revisado ..
while True:
